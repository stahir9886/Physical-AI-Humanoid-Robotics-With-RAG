...
const config: Config = {
  ...
  tagline: 'Interactive Learning with RAG-Powered Chatbot',
  ...
  baseUrl: '/Physical-AI-Humanoid-Robotics/', // Use your repository name
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'AI Chatbot',
              href: '#chatbot', // Placeholder for chatbot component
            },
          ],
        },
      ],
